        ...
        <div className="ml-auto flex items-center gap-2 lg:ml-3">
          ...
          {user && (
            ...
            >
              ...
              <span className="max-w-[9rem] truncate font-mono text-[0.6rem] uppercase tracking-[0.14em] text-ink-dim">
                {user.name}
              </span>
            </div>
          )}
          ...
          {user && (
            <button
              type="button"
              onClick={signOut}
              className="grid h-9 w-9 place-items-center rounded-lg border border-hairline text-ink-dim transition-colors hover:border-alert/50 hover:text-alert"
              aria-label="Sign out"
              title="Sign out"
            >
              <LogOut size={16} />
