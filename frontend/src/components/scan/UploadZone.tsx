...
import { ACCEPTED_EXTENSIONS, MAX_FILE_BYTES, UploadValidationError, validateFile } from '@/lib/upload/validation';
          ...
          <>
            ...
            <div className="mt-3 flex flex-wrap items-center justify-between gap-2">
              <p className="text-[0.68rem] text-ink-faint">
                Uploaded over HTTPS and analysed on the server. Stored privately against your account; delete any scan at any time.
              </p>
              <Button
                variant="ghost"
                size="sm"
